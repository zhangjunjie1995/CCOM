...
public class RestUtil {
    ...
    public static String getDomain() {
        if (domain == null) {
            domain = org.jeecg.common.util.SpringContextUtils.getDomain();
        }
        return domain;
    }
    ...
    public static String getPath() {
        if (path == null) {
            path = org.jeecg.common.util.SpringContextUtils.getApplicationContext().getEnvironment().getProperty("server.servlet.context-path");
        }
        return org.jeecg.common.util.oConvertUtils.getString(path);
    }
