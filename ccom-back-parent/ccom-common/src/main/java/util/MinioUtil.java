...
public class MinioUtil {
    ...
    public static void setMinioUrl(String minioUrl) {
        org.jeecg.common.util.MinioUtil.minioUrl = minioUrl;
    }

    public static void setMinioName(String minioName) {
        org.jeecg.common.util.MinioUtil.minioName = minioName;
    }

    public static void setMinioPass(String minioPass) {
        org.jeecg.common.util.MinioUtil.minioPass = minioPass;
    }

    public static void setBucketName(String bucketName) {
        org.jeecg.common.util.MinioUtil.bucketName = bucketName;
    }
    ...
    public static String upload(MultipartFile file, String bizPath, String customBucket) {
        ...
        if(org.jeecg.common.util.oConvertUtils.isNotEmpty(customBucket)){
        ...
        try {
            ...
            orgName = org.jeecg.common.util.CommonUtils.getFileName(orgName);
