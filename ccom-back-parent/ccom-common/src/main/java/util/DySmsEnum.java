...
public enum DySmsEnum {
	...
	public static org.jeecg.common.util.DySmsEnum toEnum(String templateCode) {
		if(StringUtils.isEmpty(templateCode)){
			return null;
		}
		for(org.jeecg.common.util.DySmsEnum item : org.jeecg.common.util.DySmsEnum.values()) {
