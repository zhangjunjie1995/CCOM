...
public class PmsUtil {
    ...
    public void setUploadPath(String uploadPath) {
        org.jeecg.common.util.PmsUtil.uploadPath = uploadPath;
    }

    public static String saveErrorTxtByList(List<String> msg, String name) {
        Date d = new Date();
        String saveDir = "logs" + File.separator + org.jeecg.common.util.DateUtils.yyyyMMdd.get().format(d) + File.separator;
        ...
        name += org.jeecg.common.util.DateUtils.yyyymmddhhmmss.get().format(d) + Math.round(Math.random() * 10000);
