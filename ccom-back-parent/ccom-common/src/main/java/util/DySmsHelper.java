...
public class DySmsHelper {
	...
	private final static Logger logger= LoggerFactory.getLogger(org.jeecg.common.util.DySmsHelper.class);
    ...
    public static void setAccessKeyId(String accessKeyId) {
        org.jeecg.common.util.DySmsHelper.accessKeyId = accessKeyId;
    }

    public static void setAccessKeySecret(String accessKeySecret) {
        org.jeecg.common.util.DySmsHelper.accessKeySecret = accessKeySecret;
    }
